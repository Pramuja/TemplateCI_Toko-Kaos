			...
			<div class="main-content">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?=base_url()?>assets/img/kaoss1.JPG" class="img-responsive" style="height: 400px; width: 100%;">
                            </div>
                            <div class="content">
                                <h3>Cressida</h3>
                    ...
                    <div class="col-sm-3">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?=base_url()?>assets/img/kaoss2.JPG" class="img-responsive" style="height: 400px; width: 100%;">
                            </div>
                            <div class="content">
                                <h3>Cressida</h3>
                                <p>Kode 2 || Harga:200K</p>
                                <a href="#beli" class="btn btn-default btnD" data-toggle="modal">Beli</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?=base_url()?>assets/img/kaoss3.JPG" class="img-responsive" style=" height: 400px; width: 100%;">
                            </div>
                            <div class="content">
                                <h3>Cressida</h3>
                                <p>Kode 3 || Harga:200K</p>
                                <a href="#beli" class="btn btn-default btnD" data-toggle="modal">Beli</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-3">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?=base_url()?>assets/img/kaoss4.JPG" class="img-responsive" style="height: 400px; width: 100%;">
                            </div>
                            <div class="content">
                                <h3>Cressida</h3>
                    ...
                    <div class="col-sm-3">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?=base_url()?>assets/img/kaoss5.JPG" class="img-responsive" style="height: 400px; width: 100%;">
                            </div>
                            <div class="content">
                                <h3>Cressida</h3>
                                <p>Kode 5 || Harga: 250K</p>
                                <a href="#beli" class="btn btn-default btnD" data-toggle="modal">Beli</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?=base_url()?>assets/img/kaoss6.JPG" class="img-responsive" style=" height: 400px; width: 100%;">
                            </div>
                            <div class="content">
                                <h3>Cressida</h3>
