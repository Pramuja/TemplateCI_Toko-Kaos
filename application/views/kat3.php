			...
			<div class="main-content">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?=base_url()?>assets/img/kaaos1.JPG" class="img-responsive" style="height: 400px; width: 100%;">
                            </div>
                            <div class="content">
                                <h3>Lois</h3>
                    ...
                    <div class="col-sm-3">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?=base_url()?>assets/img/kaaos2.JPG" class="img-responsive" style="height: 400px; width: 100%;">
                            </div>
                            <div class="content">
                                <h3>Lois</h3>
                    ...
                    <div class="col-sm-3">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?=base_url()?>assets/img/kaaos3.JPG" class="img-responsive" style=" height: 400px; width: 100%;">
                            </div>
                            <div class="content">
                                <h3>Lois</h3>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-3">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?=base_url()?>assets/img/kaaos4.JPG" class="img-responsive" style="height: 400px; width: 100%;">
                            </div>
                            <div class="content">
                                <h3>Lois</h3>
                    ...
                    <div class="col-sm-3">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?=base_url()?>assets/img/kaaos5.JPG" class="img-responsive" style="height: 400px; width: 100%;">
                            </div>
                            <div class="content">
                                <h3>Lois</h3>
                    ...
                    <div class="col-sm-3">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?=base_url()?>assets/img/kaaos6.JPG" class="img-responsive" style=" height: 400px; width: 100%;">
                            </div>
                            <div class="content">
                                <h3>Lois</h3>
