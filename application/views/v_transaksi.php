...
<div class="col-md-6">
	<table id="example" class="table table-hover table-striped">
		...
		<tbody>
			<?php $no=0; foreach($tampil_barang as $kaos): $no++; ?>
			<tr>
				<td><?=$no?></td>
				<td><?=$kaos->nama_barang?></td>
				<td><?=$kaos->harga?></td>
				<td><?=$kaos->stok?></td>
				<td><?=$kaos->nama_kategori?></td>
				<?php if($kaos->stok>0): ?>
				<td><a href="<?=base_url('index.php/transaksi/addcart/'.$kaos->id_barang)?>" class="btn btn-info">Pesan</a></td>
